...
void FindDialog::on_buttonBox_rejected() { reject(); }
...
QString FindDialog::text() const { return m_text; }

bool FindDialog::backwards() const { return m_backwards; }

bool FindDialog::wholeword() const { return m_wholeword; }

bool FindDialog::caseSensitive() const { return m_caseSensitive; }
...
void FindDialog::save() {
  ...
  m_wholeword = ui->chkWholeWord->isChecked();
  m_backwards = false;
}
