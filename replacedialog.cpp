...
ReplaceDialog::~ReplaceDialog() { delete ui; }

void ReplaceDialog::on_buttonBox_rejected() { reject(); }
...
void ReplaceDialog::init() {
  ...
  ui->buttonBox->addButton(btnReplace,
...
QString ReplaceDialog::replaceText() const { return m_replaceText; }

QString ReplaceDialog::text() const { return m_text; }

bool ReplaceDialog::all() const { return m_all; }
